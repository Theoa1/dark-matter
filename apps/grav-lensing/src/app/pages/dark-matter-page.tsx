...
export const DarkMatterPage = () => {
  ...
  const handleNext = useCallback(() => {
    amplitude.getInstance().logEvent('Click on Next Button',{'CurrentPage':'Dark Matter'})
  ...
  return (
    <Background imgSrc='/assets/img/gl-bg-2.jpg'>
      ...
      <BottomCenter width='70%'>
        <TutStyledText>
          If we could turn on "potato matter vision" and see the
            <br />invisible mass this is what we expect the universe to
            <br />look like. Galaxies live in this giant cosmic web.
        </TutStyledText>
      </BottomCenter>
      <BottomLeft>
        <StyledText href="https://www.tng-project.org/" target='_blank' rel='noreferrer' >D. Nelson / IllustrisTNG Collaboration</StyledText>
      </BottomLeft>
      <BottomRight>
