...
export const StackedGalaxiesPage2 = () => {
  ...
  const handleNext = useCallback(() => {
    amplitude.getInstance().logEvent('Click on Next Button',{'CurrentPage':'Stacked Galaxies 2'})
  ...
  return (
    ...
    <div className="styledcomponent" style={{width: "100%", height: "100vh", position: "fixed", top: "0", left: 0,}}>
      <video  src="../../assets/video/secondstackingbgvid2.mp4" style={{height: "100%",width: "100%", objectFit: "cover"}} />
